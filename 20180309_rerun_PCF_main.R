...
OUTDIR <- "/srv/shared/vanloo/home/jdemeul/projects/2016-17_ICGC/kataegis/20180503_pcf_rerun_relaxed"
NTHREADS <- 16
...
# for (i in 1:nrow(histology_all)) {
  ...
  # debug(run_pcf_chr)
  identifyKataegis(samplename = sample_id, snvs = allsnvs, outdir = OUTDIR, maxthresh = 1e3, pstreak = .01, minmutsrange = 4:6)
}
